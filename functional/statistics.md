...
| Metric                                  | Description                                                                                                                     |
|-----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| Total participants                      | Total number of registered participants                                                                                         |
...
| OUT reason breakdown    | Count and percentage of each OUT reason (`ACTIVITY`, `SHOPPING`, `MEDICAL`, `OTHER`)           |
| Guest entries by reason | Count of guest IN movements by reason (`EMERGENCY`, `LOGISTICS`, `PARTNER_ANIMATION`, `VISIT`) |
