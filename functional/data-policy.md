...
The application enforces automatic data retention rules in compliance with GDPR requirements. Personal data is never
...
A user **cannot be deleted** if they are the sole permanent `ADMIN` on one or more projects. Before their account can be
